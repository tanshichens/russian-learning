  ...
  <div className="home-container">
    ...
    <main>
      ...
      <section className="sections">
        ...
        <div className="section">
          <img src={HeadphoneIcon} alt="真题精听" className="section-img" />
          <h3>真题精听</h3>
          <p>真题听力训练，提升听力水平。</p>
          <Link to="/listening" className="btn">开始练习</Link>
        </div>
        <div className="section">
          <img src={DownloadIcon} alt="真题下载" className="section-img" />
          <h3>真题下载</h3>
          <p>历年真题下载，备考更轻松。</p>
          <Link to="/downloads" className="btn">下载真题</Link>
        </div>
        <div className="section">
          <img src={DownloadIcon} alt="高频词下载" className="section-img" />
          <h3>高频词下载</h3>
